...
* Site: https://keras.io/
* Description: Keras is an open-source library and multi-backend framework that provides a Python interface for artificial neural networks and deep learning.
* What it means: The name derives from the Ancient Greek word κέρας (Keras) meaning 'horn'.
...
* Site: https://github.com/medusajs/medusa
* Description: Medusa is a set of commerce modules and tools that allow you to build rich, reliable, and performant commerce applications without reinventing core commerce logic. The modules can be customized and used to build advanced ecommerce stores, marketplaces, or any product that needs foundational commerce primitives.
* What it means: In Greek mythology, Medusa is a Gorgon, a monstrous figure with snakes for hair, whose gaze turns anyone who looks at her into stone.
